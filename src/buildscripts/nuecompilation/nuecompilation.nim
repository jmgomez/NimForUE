...
#generateFFIGenFile(config) # this is currently generated by nue g, but it should be generated by host itself here!
  ...
  doAssert(execCmd(&"nim cpp --header:NimForUEFFI.h --debugger:native --threads --tlsEmulation:off --app:lib --d:host --nimcache:.nimcache/host src/hostnimforue/hostnimforue.nim") == 0)
  # copy header
